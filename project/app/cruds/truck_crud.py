...
class TruckCrud:
    ...
    def create(carrier_id, plate, category, release_year):
        ...
        match category:
            case "light":
                return Truck.objects.create(carrier=carrier, plate=plate, axles_count=2, 
                                     cargo_length=5.5, cargo_width=2.2, cargo_height=2.2,
                                     max_payload_kg=3000.0, euro=5, is_active=False,
                                     release_year=release_year, total_trips=0,
                                     max_fuel_capacity=150)
            case "medium":
                return Truck.objects.create(carrier=carrier, plate=plate, axles_count=3, 
                                     cargo_length=8.5, cargo_width=2.5, cargo_height=2.6,
                                     max_payload_kg=14000.0, euro=6, is_active=False,
                                     release_year=release_year, total_trips=0,
                                     max_fuel_capacity=550)
            case "heavy":
                return Truck.objects.create(carrier=carrier, plate=plate, axles_count=5, 
                                     cargo_length=14.0, cargo_width=2.6, cargo_height=2.8,
                                     max_payload_kg=25000.0, euro=6, is_active=False,
                                     release_year=release_year, total_trips=0,
