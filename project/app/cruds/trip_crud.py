...
class TripCrud:
    @staticmethod
    def create(truck_id, depot_id, departure_date, arrival_date, 
        ...
        return Trip.objects.create(truck=truck, origin_depot=depot, 
                                   ...
                                   carbon_kg_co2=None, status="Plan")
    ...
    def delete(trip_id):
        ...
        if trip.status in ["InTr", "Comp"]:
            raise ValueError("Delete trip denied. This trip is in transit or has already " \
            "been completed")
