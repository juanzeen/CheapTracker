...
class OrderApiView(AuthBaseView):
  def get(self, request, *args, **kwargs):
      try:
        ...
        return self.SuccessJsonResponse("Order successfully retrieved!", model_to_dict(order))
      except ValueError:
  ...
  def delete(self, request, *args, **kwargs):
      try:
        ...
        return self.SuccessJsonResponse("Order successfully deleted!", model_to_dict(order))
      except ValueError:
        return self.ErrorJsonResponse("Order not founded!", 404)
