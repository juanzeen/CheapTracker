...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        models = [Delivery, Box, Order, Trip, Truck, Carrier, Depot, Store, Address, Usuario]
        for m in models:
        ...
        admin, _ = Usuario.objects.get_or_create(
            ...
            defaults={
                'name': 'Admin User', 'age': 40, 'role': UserRoles.ADM,
        ...
        def create_order_with_boxes(store_obj, trip_obj, status_enum, scheduled_bool=True):
        ...
        for t in all_trips:
            ...
            t.save()
            self.stdout.write(self.style.SUCCESS(f"Updated Trip {t.id} [{t.get_status_display()}]: {len(t_orders)} orders."))

        self.stdout.write(self.style.SUCCESS("Database seeded successfully with comprehensive data!"))